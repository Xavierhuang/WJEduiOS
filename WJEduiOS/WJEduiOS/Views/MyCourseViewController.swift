...
class MyCourseViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.changeBackButton(#selector(self.rightBarButtonAction(_:)), title: AppPlist.UserViewConfigText.UserViewConfigTextBottom[1],viewController: self)
    }
...
extension MyCourseViewController:NavigationP{
    /**
     导航栏右键
     */
